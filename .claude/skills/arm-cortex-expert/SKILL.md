...
description: Firmware and driver development for ARM Cortex-M microcontrollers (Teensy 4.x, STM32, nRF52, SAMD). Use when writing peripheral drivers (I2C/SPI/UART/ADC/PWM/USB/CAN), interrupt handlers, DMA pipelines, or RTOS integration on Cortex-M targets — especially for M7 memory barriers, DMA/cache coherency, ISR-safe ring buffers, and bare-metal register-level code.
---
